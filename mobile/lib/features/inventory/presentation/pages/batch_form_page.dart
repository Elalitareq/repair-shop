...
class _BatchFormPageState extends ConsumerState<BatchFormPage> {
  ...
  Future<void> _submit() async {
    ...
    final data = {
      ...
      if (widget.itemId != null) 'itemId': widget.itemId,
    };
      ...
      if (batch != null && _productType == 'phone' && widget.batchId == null) {
        ...
        for (final imei in _serialNumbers) {
          final result = await serialService.createSerial({
            'imei': imei,
            'itemId': widget.itemId ?? 0, // This shouldn't happen for editing
              ...
              child: Form(
                ...
                child: ListView(
                  children: [
                    ...
                    // Batch number is generated by the server, so only show it on edit (read-only)
                    if (widget.batchId != null)
                      TextFormField(
